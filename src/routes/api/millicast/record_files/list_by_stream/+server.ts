...
export async function GET(event) {
    ...
    const streamname = event.url.searchParams.get('streamname');

    let url = `${MILLICAST_API_ENDPOINT}/api/record_files/list_by_stream?sortBy=${sortBy}&page=${page}&itemsOnPage=${itemsOnPage}&isDescending=${isDescending}&streamname=${streamname}`;
