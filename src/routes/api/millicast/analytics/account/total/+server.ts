...
export async function GET(event) {
    ...
    const url = `${MILLICAST_API_ENDPOINT}/api/analytics/account/total?startDate=${startDate}&stopDate=${stopDate}`
...
/*
GET http://localhost:5173/api/millicast/analytics/account/total?startDate=2023-11-14&stopDate=2023-11-21
{"bytesOut":152351904315,"bytesIn":147317575295}
